...
from config.image_config import all_openrag_repos, IMAGE_ORG, IMAGE_NAME_BACKEND
...
class ContainerManager:
    ...
    # Populated at import time from image_config so registry/org overrides are
    # respected without changing this file.
        ...
        try:
            ...
            if success and stdout.strip():
                ...
                if ":" in image_tag:
                    ...
                    # Strip any architecture suffix (e.g. "0.1.47-ppc64le" -> "0.1.47")
                    if "-" in version:
                        candidate = version.rsplit("-", 1)[0]
                        # Only strip if the remaining part looks like a version number
